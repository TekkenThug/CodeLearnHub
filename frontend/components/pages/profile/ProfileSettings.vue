...
import SettingsDeleteModal from '~/components/pages/settings/SettingsDeleteModal'
import UiUploader from '~/components/ui/uploader/UiUploader'
...
const { value: nickname } = useField('nickname', 'isRequired', {
    validateOnValueUpdate: false
})
